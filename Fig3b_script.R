...
fig3b_data<-read.table("C:/Users/Darlene1122/Desktop/Fig3b_data.txt", header = FALSE)
...
ggplot() +
  ...
  geom_text(data = fig3b_data, aes(x = V2, y =V3,label = V3), colour = "black",size=3, vjust = -0.8) +
